...
\begin{quote}
( dl dh -- dl\textquotesingle{} dh\textquotesingle{} ) \end{quote}


\begin{quote}
( d1l d1h d2l d2h -- drl drh dql dqh ) \end{quote}
...
a F\+OR..W\+H\+I\+LE..N\+E\+XT..E\+L\+SE..T\+H\+EN construct =$\sim$ for \{..break..\}

if digit, x\+B\+A\+SE, else break to E\+L\+SE
...
out-\/of-\/range put \textquotesingle{}\+\_\+\textquotesingle{} instead

LF i.\+e. ~\newline
 actually

Note\+: D\+O\+T\+QP export to \+\_\+dotq
...
if (len) \{ --len; if (delim==\char`\"{} \char`\"{}) \{...\} \}

a F\+OR..W\+H\+I\+LE..N\+E\+XT..T\+H\+EN construct =$\sim$ for \{..break..\}

for (len)

break to T\+H\+EN if is char, or next char

no break, (R$>$, D\+R\+OP to rm loop counter)

populate A0, i.\+e. break comes here, rm counter

advance until next space found

a F\+OR..W\+H\+I\+LE..N\+E\+XT..E\+L\+SE..T\+H\+EN construct =$\sim$ DO..L\+E\+A\+VE..+L\+O\+OP

if (char $<$= space) break to E\+L\+SE

no break, if counter $<$ limit loop back to F\+OR

R$>$, D\+R\+OP to rm loop counter
...
echo and store new char to T\+IB
...
store new char into T\+IB

check if done

keep token length in \#\+T\+IB
...
I\+N\+T\+E\+R0 of Dr Ting\textquotesingle{}s
...
fetch operation mode (\$\+I\+N\+T\+E\+R\+P\+R\+ET or \$\+C\+O\+M\+P\+I\+LE)

execute according to mode

clear T\+IB, interpreter mode
...
add new name field which is already build by P\+A\+CK\$
...
\begin{DoxyItemize}
\item check second byte is E\+X\+IT
\end{DoxyItemize}
...
find quote in T\+IB (0x22 is " in A\+S\+C\+II)
...
enable C\+O\+M\+P\+I\+L\+E-\/\+O\+N\+LY flag

enable I\+M\+M\+E\+D\+I\+A\+TE flag
...
enter the main query loop (Q\+U\+IT)
