...
\begin{DoxyItemize}
\item L\+ED blinker (assume you have a blue L\+ED on pin 6, and set for O\+U\+T\+P\+UT, or try this at \href{https://wokwi.com/projects/356793878308297729}{\texttt{ \mbox{[}this Wokwi project\mbox{]}}}) 
\begin{DoxyPre}
...
\item Timer Interrupt Service Routine (a red L\+ED on pin 5, and set for O\+U\+T\+P\+UT) 
\begin{DoxyPre}
...
\begin{DoxyPre}
    ...
    > 24299 0 ok>                            \textbackslash{} 24299ms =\string~ 24us/cycle (with ISR running in the background)
    \end{DoxyPre}
